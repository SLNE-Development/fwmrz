...
<div class="bg-zinc-900 border-b border-zinc-800 pt-12 pb-10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p class="text-zinc-400 max-w-2xl">Vielen Dank für Ihr Interesse an einer Mitgliedschaft in der Freiwilligen Feuerwehr der Gemeinde Merzenich.</p>
    </div>
</div>
...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-14">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        {{-- Aktive Feuerwehr --}}
        <div class="bg-zinc-900 border border-zinc-800 hover:border-red-700/50 rounded-2xl p-8 transition-all duration-300 hover:-translate-y-1 group">
            <div class="w-14 h-14 bg-red-900/40 border border-red-800/40 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-red-900/60 transition-colors">
            ...
            <h2 class="text-xl font-bold text-white mb-3">Freiwillige Feuerwehr</h2>
            <p class="text-zinc-400 leading-relaxed mb-6">
                Ab dem <strong class="text-white">17. Lebensjahr</strong> bist du Teil der aktiven Abteilung.
                Es gibt keine Altersbeschränkung für den Eintritt –
                selbstverständlich sind Frauen und Männer gleichermaßen herzlich willkommen.
                Mit Vollendung des 67. Lebensjahres (auf Antrag auch früher) kann man in die Ehrenabteilung wechseln.
            </p>
            <ul class="space-y-2 text-sm text-zinc-300 mb-8">
        ...
        {{-- Jugendfeuerwehr --}}
        <div class="bg-zinc-900 border border-zinc-800 hover:border-amber-700/50 rounded-2xl p-8 transition-all duration-300 hover:-translate-y-1 group">
            <div class="w-14 h-14 bg-amber-900/30 border border-amber-800/30 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-amber-900/50 transition-colors">
            ...
            <h2 class="text-xl font-bold text-white mb-3">Jugendfeuerwehr</h2>
            <p class="text-zinc-400 leading-relaxed mb-6">
                Jugendliche ab dem <strong class="text-white">10. Lebensjahr</strong> können Mitglied in der
                Jugendfeuerwehr werden. Hier lernen sie spielerisch den Umgang mit feuerwehrtechnischem Gerät,
            ...
            <ul class="space-y-2 text-sm text-zinc-300 mb-8">
                ...
                <li class="flex items-center gap-2">
                    <svg class="w-4 h-4 text-amber-500 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5"/></svg>
                    {{ $feat }}
                </li>
                @endforeach
            </ul>
            <a href="{{ route('kontakt') }}"
               class="inline-flex items-center gap-2 border border-amber-700/60 hover:bg-amber-900/30 text-amber-400 font-semibold px-6 py-3 rounded-xl transition-colors w-full justify-center">
                Interesse anmelden
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
            </a>
        </div>
    ...
    <div class="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-8 text-center">
        <h2 class="text-xl font-bold text-white mb-3">Fördernde Mitgliedschaft</h2>
