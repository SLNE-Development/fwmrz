...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-20">
    ...
    <section>
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div>
                <span class="inline-block text-xs text-red-400 font-semibold uppercase tracking-widest mb-3">Führung</span>
                <h2 class="text-2xl sm:text-3xl font-bold text-white mb-4">Wehrleitung</h2>
            ...
            <div class="bg-zinc-900 border border-zinc-800 rounded-2xl p-8">
                <div class="flex items-center gap-4 mb-4">
                    <div class="w-14 h-14 bg-red-900/40 border border-red-800/40 rounded-full flex items-center justify-center">
                        <svg class="w-7 h-7 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z"/></svg>
                    </div>
                    <div>
                        <div class="font-bold text-white">Patrick Harzheim</div>
                        <div class="text-sm text-red-400">Wehrleiter</div>
                    </div>
                </div>
                <div class="space-y-2 text-sm text-zinc-400">
                    <div class="flex items-center gap-2"><svg class="w-4 h-4 text-zinc-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75"/></svg><a href="mailto:wehrleitung@gemeinde-merzenich.de" class="hover:text-red-400 transition-colors">wehrleitung@gemeinde-merzenich.de</a></div>
    ...
    {{-- Löschgruppen --}}
    <section>
        <span class="inline-block text-xs text-red-400 font-semibold uppercase tracking-widest mb-3">Einheiten</span>
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-4">Unsere Löschgruppen</h2>
        <p class="text-zinc-400 max-w-2xl mb-8">Innerhalb unserer Gemeinde gibt es 4 Löschgruppen in Merzenich, Golzheim, Morschenich und Girbelsrath.</p>

        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            @foreach(['Merzenich', 'Golzheim', 'Morschenich', 'Girbelsrath'] as $lg)
            <div class="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
                <div class="w-10 h-10 bg-red-900/30 border border-red-900/30 rounded-xl flex items-center justify-center mb-4">
                    <svg class="w-5 h-5 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M15.362 5.214A8.252 8.252 0 0112 21 8.25 8.25 0 016.038 7.048 8.287 8.287 0 009 9.6a8.983 8.983 0 013.361-6.867 8.21 8.21 0 003 2.48z"/></svg>
                </div>
                <h3 class="font-bold text-white mb-3">LG {{ $lg }}</h3>
                <ul class="space-y-1.5 text-sm text-zinc-400">
                    ...
                    <li class="flex items-center gap-2"><span class="w-1.5 h-1.5 rounded-full bg-zinc-500 shrink-0"></span>Ehrenabteilung</li>
                </ul>
            </div>
            @endforeach
        </div>
    ...
    {{-- Mitglieder Zahlen --}}
    <section class="bg-zinc-900/40 border border-zinc-800 rounded-3xl p-8 sm:p-12">
        <h2 class="text-2xl font-bold text-white mb-8 text-center">Mitglieder auf einen Blick</h2>
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
            <div><div class="text-4xl font-bold text-red-500 mb-2">~100</div><div class="text-zinc-400">Aktive Kameradinnen &amp; Kameraden</div></div>
            <div><div class="text-4xl font-bold text-amber-500 mb-2">~30</div><div class="text-zinc-400">Jugendfeuerwehr-Mitglieder</div></div>
            <div><div class="text-4xl font-bold text-zinc-400 mb-2">20</div><div class="text-zinc-400">Kameraden in der Ehrenabteilung</div></div>
        </div>
    </section>
    ...
    <section>
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
            <div>
                <span class="inline-block text-xs text-red-400 font-semibold uppercase tracking-widest mb-3">Qualifikation</span>
                <h2 class="text-2xl sm:text-3xl font-bold text-white mb-4">Ausbildung</h2>
                <p class="text-zinc-400 leading-relaxed mb-6">
                    Die Ausbildung in der Feuerwehr ist sehr vielfältig. Die Laufbahrlehrgänge sind maßgebend für den Dienstgrad.
                </p>
                <div class="space-y-3">
                    <h4 class="text-sm font-semibold text-white uppercase tracking-wider">Laufbahrlehrgänge</h4>
                    @foreach([
                    ...
                    <div class="flex items-center gap-3 bg-zinc-900 border border-zinc-800 rounded-xl px-4 py-3">
                        ...
                        <span class="text-zinc-200 text-sm font-medium">{{ $lehrgang['label'] }}</span>
            ...
            <div>
                <h4 class="text-sm font-semibold text-white uppercase tracking-wider mt-10 lg:mt-10 mb-3">Sonderlehrgänge</h4>
                <div class="space-y-3">
                    @foreach([
                    ...
                    <div class="flex items-center gap-3 bg-zinc-900 border border-zinc-800 rounded-xl px-4 py-3">
                        ...
                        <span class="text-zinc-200 text-sm">{{ $slg }}</span>
                    </div>
                    @endforeach
                </div>

                <div class="mt-8 bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
                    <h4 class="font-semibold text-white mb-2">Einsatzgeschehen &amp; Notruf</h4>
