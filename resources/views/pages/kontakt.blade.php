...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-12">
            ...
            <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6">
                ...
                <div class="space-y-3 text-sm text-zinc-600 dark:text-zinc-400">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a href="tel:+4924213990" class="hover:text-red-500 dark:hover:text-red-400 transition-colors">+49 2421 399-0</a>
                    </div>
                    <div class="flex items-center gap-3">
                        <svg class="w-4 h-4 text-red-500 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75"/></svg>
                        <a href="mailto:wehrleitung@gemeinde-merzenich.de" class="hover:text-red-500 dark:hover:text-red-400 transition-colors break-all">wehrleitung@gemeinde-merzenich.de</a>
                    </div>
                </div>
            </div>
            <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800/40 rounded-2xl p-6 text-center">
                <p class="text-sm text-zinc-700 dark:text-zinc-300 mb-2 font-medium">Im Notfall bitte immer:</p>
                <a href="tel:112" class="text-5xl font-bold text-red-600 dark:text-red-500 hover:text-red-700 dark:hover:text-red-400 transition-colors">112</a>
        ...
        <div class="lg:col-span-3">
            @if(session('success'))
            <div class="bg-green-50 dark:bg-green-900/30 border border-green-300 dark:border-green-800 text-green-700 dark:text-green-400 rounded-xl px-5 py-4 mb-6 text-sm">
            ...
            <form action="{{ route('kontakt.send') }}" method="POST" class="space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                        <label class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1.5">Name <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1.5">Telefon</label>
                        <input type="tel" name="phone" value="{{ old('phone') }}"
                               class="w-full bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 focus:border-red-500 dark:focus:border-red-600 focus:ring-1 focus:ring-red-500 dark:focus:ring-red-600 text-zinc-900 dark:text-white placeholder-zinc-400 dark:placeholder-zinc-600 rounded-xl px-4 py-3 text-sm outline-none transition-colors">
                    </div>
                </div>
                <div>
                    <label class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1.5">E-Mail-Adresse <span class="text-red-500">*</span></label>
                    <input type="email" name="email" value="{{ old('email') }}" required
                           class="w-full bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 focus:border-red-500 dark:focus:border-red-600 focus:ring-1 focus:ring-red-500 dark:focus:ring-red-600 text-zinc-900 dark:text-white placeholder-zinc-400 dark:placeholder-zinc-600 rounded-xl px-4 py-3 text-sm outline-none transition-colors">
                    @error('email')<p class="text-xs text-red-500 mt-1">{{ $message }}</p>@enderror
                </div>
                <div>
                    <label class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1.5">Betreff <span class="text-red-500">*</span></label>
                ...
                <div>
                    <label class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1.5">Nachricht <span class="text-red-500">*</span></label>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <label for="privacy" class="text-sm text-zinc-600 dark:text-zinc-400">
                        Ich habe die <a href="{{ route('datenschutz') }}" class="text-red-600 dark:text-red-400 hover:underline" target="_blank">Datenschutzerklärung</a> gelesen und akzeptiere diese. <span class="text-red-500">*</span>
                    </label>
                </div>
                <button type="submit"
