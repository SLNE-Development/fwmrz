...
<section class="border-y border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-10">
            <span class="text-xs text-red-600 dark:text-red-400 font-semibold uppercase tracking-widest">Technik</span>
            <h2 class="text-3xl sm:text-4xl font-bold text-zinc-900 dark:text-white mt-1 mb-2">Unsere Fahrzeuge</h2>
            <p class="text-zinc-500 dark:text-zinc-400 max-w-xl">Moderne Einsatzfahrzeuge für alle Lagen – von der Brandbekämpfung bis zur technischen Hilfeleistung.</p>
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">

            @php
            $fahrzeuge = [
                ['name' => 'HLF 20',          'sub' => 'Hilfeleistungslöschfahrzeug', 'lg' => 'LG Merzenich',    'img' => '/images/fahrzeuge/hlf20.jpg'],
                ['name' => 'LF 10',           'sub' => 'Löschfahrzeug',               'lg' => 'LG Golzheim',     'img' => '/images/fahrzeuge/lf10.jpg'],
                ['name' => 'TLF 3000',        'sub' => 'Tanklöschfahrzeug',           'lg' => 'LG Morschenich',  'img' => '/images/fahrzeuge/tlf3000.jpg'],
            ];
            @endphp

            @foreach($fahrzeuge as $fz)
            <div class="group bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 hover:border-red-300 dark:hover:border-red-800 rounded-2xl overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-red-100 dark:hover:shadow-red-950/20">
                {{-- Fahrzeugbild --}}
                <div class="relative aspect-[16/9] overflow-hidden bg-zinc-200 dark:bg-zinc-800">
                    ...
                    <div class="absolute inset-0 hidden items-center justify-center bg-zinc-100 dark:bg-zinc-800 flex-col gap-3"
                         style="display: flex;">
                        <svg class="w-14 h-14 text-zinc-300 dark:text-zinc-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 00-3.213-9.193 2.056 2.056 0 00-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 00-10.026 0 1.106 1.106 0 00-.987 1.106v7.635m12-6.677v6.677m0 4.5v-4.5m0 0h-12"/>
                        </svg>
                    ...
                    <div class="absolute top-3 left-3">
                        <span class="bg-red-600 text-white text-xs font-bold px-2.5 py-1 rounded-md uppercase tracking-wider shadow">{{ $fz['name'] }}</span>
                    </div>
                </div>
                <div class="p-5">
                    <div class="flex items-start justify-between gap-2">
                        ...
                        <span class="shrink-0 text-xs text-zinc-400 dark:text-zinc-500 bg-zinc-100 dark:bg-zinc-800 px-2 py-0.5 rounded-md">{{ $fz['lg'] }}</span>
                    </div>
                </div>
            </div>
            @endforeach
...
<section class="bg-zinc-50 dark:bg-zinc-900/40 border-b border-zinc-200 dark:border-zinc-800 py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 hover:border-red-300 dark:hover:border-red-700/50 rounded-2xl p-6 transition-all duration-300 hover:-translate-y-1 group">
                {{-- Feuerwehrhelm-Icon --}}
                <div class="w-12 h-12 bg-red-50 dark:bg-red-900/30 border border-red-100 dark:border-red-900/40 rounded-xl flex items-center justify-center mb-4">
                    <svg class="w-7 h-7 text-red-600 dark:text-red-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 3C8 3 4.5 6 4 10H3a1 1 0 00-1 1v1a1 1 0 001 1h18a1 1 0 001-1v-1a1 1 0 00-1-1h-1C19.5 6 16 3 12 3z"/>
                        <path stroke-linecap="round" stroke-linejoin="round" d="M5 13v1a2 2 0 002 2h10a2 2 0 002-2v-1"/>
...
<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
    <div class="relative overflow-hidden rounded-3xl">
        ...
        <div class="relative px-8 sm:px-14 py-16 text-center">
            ...
            <p class="text-zinc-300 max-w-lg mx-auto mb-8 leading-relaxed">Ab dem 10. Lebensjahr in der Jugendfeuerwehr – ab 17 in der aktiven Abteilung. Jeder ist willkommen!</p>
            <a href="{{ route('mitmachen') }}"
