...
<head>
    ...
    <meta name="description" content="@yield('description', 'Offizielle Website der Freiwilligen Feuerwehr Merzenich – Wir schützen Merzenich.')">
...
<body class="bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 font-sans antialiased">
    ...
    <header id="site-header" class="sticky top-0 z-50 border-b border-transparent">
            ...
            <div class="flex items-center justify-between h-16 lg:h-18">
                <a href="{{ route('home') }}" class="flex items-center gap-3 group shrink-0">
                    ...
                    <div class="hidden sm:block">
                        <div class="text-zinc-900 dark:text-white font-bold text-sm leading-tight">Freiwillige Feuerwehr</div>
                        <div class="text-red-600 dark:text-red-400 font-bold text-sm leading-tight tracking-wide">Merzenich</div>
                    </div>
                </a>
        ...
        <div id="mobile-nav" class="hidden lg:hidden border-t border-zinc-200 dark:border-zinc-800 bg-white/98 dark:bg-zinc-950/98 backdrop-blur-md">
    ...
    <footer class="bg-zinc-100 dark:bg-zinc-900 border-t border-zinc-200 dark:border-zinc-800 mt-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
                <div class="lg:col-span-2">
                    ...
                    <p class="text-zinc-500 dark:text-zinc-400 text-sm leading-relaxed mb-4">
                        ...
                        Tel.: <a href="tel:+492421399100" class="hover:text-red-600 dark:hover:text-red-400 transition-colors">+49 2421 399-0</a><br>
                        E-Mail: <a href="mailto:wehrleitung@gemeinde-merzenich.de" class="hover:text-red-600 dark:hover:text-red-400 transition-colors">wehrleitung@gemeinde-merzenich.de</a>
                    </p>
                ...
                <div>
                    <h3 class="text-zinc-900 dark:text-white font-semibold text-sm uppercase tracking-wider mb-4">Navigation</h3>
                    <ul class="space-y-2">
                        @foreach([
                            ['route' => 'einsaetze.index', 'label' => 'Einsätze'],
                            ['route' => 'news.index',      'label' => 'Aktuelles'],
                        ...
                        <li><a href="{{ route($item['route']) }}" class="text-zinc-500 dark:text-zinc-400 hover:text-red-600 dark:hover:text-red-400 text-sm transition-colors">{{ $item['label'] }}</a></li>
                        @endforeach
                        <li><a href="{{ url('/admin') }}" class="text-zinc-500 dark:text-zinc-400 hover:text-red-600 dark:hover:text-red-400 text-sm transition-colors">Anmelden</a></li>
                    </ul>
                </div>

                <div>
                    <h3 class="text-zinc-900 dark:text-white font-semibold text-sm uppercase tracking-wider mb-4">Partner &amp; Links</h3>
                    <ul class="space-y-2">
                        @foreach([
                            ['url' => 'https://gemeinde-merzenich.de',                                          'label' => 'Gemeinde Merzenich'],
                            ['url' => 'https://www.kfv-dueren.de/',                                             'label' => 'Kreisfeuerwehrverband Düren'],
                            ['url' => 'https://www.kfv-dueren.de/feuerwehr/feuerschutztechnischeszentrum',      'label' => 'Feuerschutztechn. Zentrum'],
                        ...
                        <li>
                            <a href="{{ $p['url'] }}" target="_blank" rel="nofollow noreferrer"
                               class="text-zinc-500 dark:text-zinc-400 hover:text-red-600 dark:hover:text-red-400 text-sm transition-colors inline-flex items-center gap-1">
                                {{ $p['label'] }}
                                <svg class="w-3 h-3 opacity-50" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/></svg>
                            </a>
                        </li>
                        @endforeach
                    </ul>
            ...
            <div class="mt-10 pt-6 border-t border-zinc-200 dark:border-zinc-800 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-zinc-400 dark:text-zinc-500">
                <span>© {{ date('Y') }} Freiwillige Feuerwehr Merzenich. Alle Rechte vorbehalten.</span>
                <div class="flex items-center gap-5">
                    <a href="{{ route('impressum') }}" class="hover:text-red-600 dark:hover:text-red-400 transition-colors">Impressum</a>
                    <a href="{{ route('datenschutz') }}" class="hover:text-red-600 dark:hover:text-red-400 transition-colors">Datenschutzerklärung</a>
                    ...
                    <button data-theme-toggle
                        ...
                        <svg data-theme-icon-light class="w-3.5 h-3.5" style="display:none" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z"/></svg>
